...
from sinc.info.joints import smplh_to_mmm_scaling_factor
from sinc.info.joints import smplh2mmm_indexes
import hydra
...
class SMPLH(Rots2Joints):
    def __init__(self, path: str,
        ...
        if not fast:
            ...
            from sinc.transforms.rots2joints.smpl_fast import SMPLIndexed
...
def smplh_to(jointstype, data, trans):
    from sinc.info.joints import get_root_idx
    if "mmm" in jointstype:
        ...
        from sinc.info.joints import smplh2smplnh_indexes
